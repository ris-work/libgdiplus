...
// Function that reads the environment variable and returns the corresponding language enum.
...
const char *language_to_str(HarfBuzzLanguage lang) {
    switch(lang) {
        ...
        case LANG_SINHALESE:  return "Sinhalese";
...
// The init function sets g_hb_language and g_hb_script based on the environment variable.
